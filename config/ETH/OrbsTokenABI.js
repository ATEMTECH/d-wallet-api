exports.OrbsInfo = {
  ...
  'ABI': {
    'delegate': [
      ...
      },
      {
        ...
        'inputs': [{'indexed': true, 'internalType': 'address', 'name': 'addr', 'type': 'address'}, {
          ...
          'type': 'uint256',
        }, {'indexed': false, 'internalType': 'uint256', 'name': 'delegatedStake', 'type': 'uint256'}, {
          'indexed': true,
          'internalType': 'address',
          'name': 'delegator',
          'type': 'address',
        }, {'indexed': false, 'internalType': 'uint256', 'name': 'delegatorContributedStake', 'type': 'uint256'}],
      ...
      },
      {
        ...
        'outputs': [{'internalType': 'address', 'name': 'delegation', 'type': 'address'}, {
          'internalType': 'uint256',
          'name': 'delegatorStake',
          'type': 'uint256',
        }],
      ...
      },
      {
        'inputs': [{'internalType': 'address[]', 'name': 'from', 'type': 'address[]'}, {
          ...
          'name': 'to',
          'type': 'address',
        }], 'name': 'importDelegations', 'outputs': [], 'stateMutability': 'nonpayable', 'type': 'function',
      },
      {
        'inputs': [{'internalType': 'address', 'name': 'from', 'type': 'address'}, {
          'internalType': 'address',
          'name': 'to',
          'type': 'address',
        }], 'name': 'initDelegation', 'outputs': [], 'stateMutability': 'nonpayable', 'type': 'function',
      },
      {
        'inputs': [],
      ...
      },
      {
        'inputs': [{'internalType': 'address', 'name': '_stakeOwner', 'type': 'address'}, {
          ...
          'name': '_updatedStake',
          'type': 'uint256',
        }], 'name': 'stakeChange', 'outputs': [], 'stateMutability': 'nonpayable', 'type': 'function',
      },
      {
        'inputs': [{
          'internalType': 'address[]',
          ...
          'name': '_signs',
          'type': 'bool[]',
        }, {'internalType': 'uint256[]', 'name': '_updatedStakes', 'type': 'uint256[]'}],
      ...
      },
      {
        'inputs': [{'internalType': 'address', 'name': '_stakeOwner', 'type': 'address'}, {
          ...
          'name': '_amount',
          'type': 'uint256',
        }], 'name': 'stakeMigration', 'outputs': [], 'stateMutability': 'nonpayable', 'type': 'function',
      },
      {
    ...
    'approve': [
      ...
      {
        'constant': false,
        'inputs': [{'name': 'from_', 'type': 'address'}, {'name': 'value_', 'type': 'uint256'}, {
          'name': 'data_',
          'type': 'bytes',
        }],
        'name': 'tokenFallback',
